...
let
  ...
  wrapArduinoCLI =
    ...
    let
      builtinPackages = builtins.map lib.latestVersion (
        builtins.attrValues pkgs.arduinoPackages.tools.builtin
      );
    ...
    pkgs.runCommand "arduino-cli-wrapped"
      {
        ...
        passthru = { inherit dataPath userPath; };
      }
      ''
      ...
      '';
in
pkgs.lib.makeOverridable wrapArduinoCLI
